...
CYCLECLOUD_SPEC_PATH=/mnt/cluster-init/genomicswfe/execute
...
chown -R ${CUSER}:${CUSER} ${HOMEDIR}/logs
cp /opt/cycle/jetpack/logs/cluster-init/genomicswfe/execute/scripts/02.nfs.sh.out ${HOMEDIR}/logs
